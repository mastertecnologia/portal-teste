				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-12">
						<div class="form-group">
							...
							<?= $this->Form->text('vlunitario', ['id' => 'vlunitario', 'class' => 'mascaramonetaria form-control', 'label' => false, 'required' => true, 'placeholder' => 'Valor']);?>
						</div>
					</div>
					<div class="col-lg-1 col-sm-12">
						<div class="form-group">
							<label class="control-label"> Ativo </label>
							<?= $this->Form->control('ativo', ['options' => C_ProdutosAtivo, 'value' => C_ProdutosAtivoSim, 'class' => 'form-control', 'label' => false, 'required' => true,]);?>
						</div>
					</div>
				</div>
				<hr>
