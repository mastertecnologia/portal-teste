...
/**
 * Garantir que papéis de equipe padrão tenham notificações internas (sino) após retirar PortalNotifications da whitelist RBAC.
 * Não altera cliente_portal (já coberto por migrations portal.*).
 */
class RbacEquipeRolesPortalNotificationsBell extends AbstractMigration {

	/** @var string[] */
	protected $_roleSlugs = ['super_admin', 'admin_equipe', 'operacao', 'financeiro', 'leitura'];

	/** @var string[] */
	protected $_permCodes = ['portal.notifications.read', 'portal.notifications.write'];
