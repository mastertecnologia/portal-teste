...
/**
 * Garantir dashboard.view nos papéis de equipe padrão após retirar Users/dashboard da whitelist RBAC.
 * Não altera cliente_portal (já coberto por migrations portal.*).
 */
class RbacEquipeRolesDashboardView extends AbstractMigration {

	/** @var string[] */
	protected $_roleSlugs = ['super_admin', 'admin_equipe', 'operacao', 'financeiro', 'leitura'];

	/** @var string[] */
	protected $_permCodes = ['dashboard.view'];
