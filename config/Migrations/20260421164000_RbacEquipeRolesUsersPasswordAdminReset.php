...
/**
 * Reset de senha de usuário portal (Users/changePasswordAdmin) — papéis que tipicamente fazem suporte.
 * Exclui leitura (só visualização).
 */
class RbacEquipeRolesUsersPasswordAdminReset extends AbstractMigration {

	/** @var string[] */
	protected $_roleSlugs = ['super_admin', 'admin_equipe', 'operacao', 'financeiro'];

	/** @var string[] */
	protected $_permCodes = ['users.password_admin_reset'];
