...
/**
 * Troca de empresa ativa (Empresas/alteraempresa) — equipe multi-empresa e portal (cliente_portal) com RBAC.
 * Remove a entrada errada users#alteraempresa na whitelist (nunca casava o controller real).
 */
class RbacEquipeRolesEmpresasSessionSwitch extends AbstractMigration {

	/** @var string[] */
	protected $_roleSlugs = ['super_admin', 'admin_equipe', 'operacao', 'financeiro', 'leitura', 'cliente_portal'];

	/** @var string[] */
	protected $_permCodes = ['empresas.session.switch'];
