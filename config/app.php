<?php
/**
 * Configuração base. Nenhuma senha ou dado sensível aqui.
...
return [
    ...
    'Datasources' => [
        'default' => [
            ...
            'persistent' => false,
            // Infra PGM: PostgreSQL em 10.0.2.23 (ver docs/INFRAESTRUTURA_SERVIDORES.md). Dev local: DB_HOST=localhost no .env
            'host' => env('DB_HOST', '10.0.2.23'),
