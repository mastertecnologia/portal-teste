 ...
 * shared configuration. Em produção: crie app_local.php com 'debug' => false.
 */
...
if (file_exists(__DIR__ . DS . 'pgm_sidebar.php')) {
    ...
    Configure::load('portal_ui_screens', 'default', false);
}
...
/*
 * Fuso horário do Brasil (São Paulo). Todas as datas/horas usam este timezone.
 * Formato de exibição: dia/mês/ano (d/m/Y) e hora 24h (H:i ou H:i:s).
 */
...
Security::setSalt((string)Configure::read('Security.salt'));
