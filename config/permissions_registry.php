...
return [
	...
	['code' => 'portal.relatorios', 'name' => 'Portal — relatórios', 'module' => 'Portal clientes', 'controller' => 'PortalRelatorios', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'cliente', 'description' => 'Resumo e exportação CSV/Excel sem dados operacionais internos.', 'sort_order' => $n()],
	['code' => 'portal.advanced.contracts', 'name' => 'Portal — contratos avançados', 'module' => 'Portal clientes', 'controller' => 'PortalAdvancedContracts', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'cliente', 'description' => 'Leitura contracts + documentos públicos. (Alias RBAC: controller PortalContratos.)', 'sort_order' => $n()],
	['code' => 'portal.advanced.invoices', 'name' => 'Portal — faturas avançadas', 'module' => 'Portal clientes', 'controller' => 'PortalAdvancedInvoices', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'cliente', 'description' => 'Leitura invoices + export CSV do próprio cliente.', 'sort_order' => $n()],
	['code' => 'portal.advanced.attendance', 'name' => 'Portal — histórico atendimento avançado', 'module' => 'Portal clientes', 'controller' => 'PortalAdvancedAttendance', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'cliente', 'description' => 'Timeline sem notas internas.', 'sort_order' => $n()],
	...
	['code' => 'erp.contracts.management', 'name' => 'Contratos — gestão (canónico)', 'module' => 'Operações', 'controller' => 'ContractManagement', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'empresa', 'description' => 'Rotas /modulo-contratos/* (substitui gradualmente AdvancedContracts na UI).', 'sort_order' => $n()],
	['code' => 'erp.contracts.templates', 'name' => 'Contratos — modelos', 'module' => 'Operações', 'controller' => 'ContractTemplates', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'empresa', 'description' => 'CRUD /contract-templates/*.', 'sort_order' => $n()],
