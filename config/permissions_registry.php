...
return [
	...
	['code' => 'portal.advanced.contracts', 'name' => 'Portal — contratos avançados', 'module' => 'Portal clientes', 'controller' => 'PortalAdvancedContracts', 'action' => '*', 'perm_type' => 'rbac', 'abac_scope' => 'cliente', 'description' => 'Leitura contracts + documentos públicos.', 'sort_order' => $n()],
