...
return [
	'Rbac' => [
		...
		'rbac_api_enforced_actions' => [
			...
			'tickets#apitimer',
			'tickets#apitimeline',
			'tickets#apivalidategeolocation',
			'tickets#apiticketsignature',
			'tickets#apipdfticketos',
			'tickets#apipdflaudo',
			'tickets#apiaddticketproduct',
			'tickets#apiaddevidencephoto',
			'audit#apivalidate',
		...
		'menu_sidebar_gates' => [
			...
			// Módulo fiscal (NF-e): secção visível se qualquer sub-permissão; cada ligação filtra pelo código.
			'fiscal_modulo' => [
				'fiscal.dashboard',
				'fiscal.notas',
			...
			'fiscal_menu_dashboard' => 'fiscal.dashboard',
			'fiscal_menu_dfe_recebidos' => 'fiscal.dashboard',
			'fiscal_menu_notas' => 'fiscal.notas',
