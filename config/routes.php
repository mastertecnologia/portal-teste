...
Router::scope('/', function ($routes) {
    ...
    $routes->connect('/modulo-contratos/edit/:id', ['controller' => 'ContractManagement', 'action' => 'edit'], ['pass' => ['id'], 'id' => '\d+']);
    ...
    $routes->redirect('/modulo-contratos/gerar-pdf', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/gerar-pdf/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/enviar-assinatura/:id', ['controller' => 'ContractManagement', 'action' => 'enviarAssinatura'], ['pass' => ['id'], 'id' => '\d+']);
    $routes->redirect('/modulo-contratos/enviar-assinatura', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/enviar-assinatura/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/aprovar/:id', ['controller' => 'ContractManagement', 'action' => 'aprovar'], ['pass' => ['id'], 'id' => '\d+'])->setMethods(['POST']);
    $routes->redirect('/modulo-contratos/aprovar', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/aprovar/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/suspender/:id', ['controller' => 'ContractManagement', 'action' => 'suspender'], ['pass' => ['id'], 'id' => '\d+'])->setMethods(['POST']);
    $routes->redirect('/modulo-contratos/suspender', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/suspender/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/cancelar/:id', ['controller' => 'ContractManagement', 'action' => 'cancelar'], ['pass' => ['id'], 'id' => '\d+'])->setMethods(['POST']);
    $routes->redirect('/modulo-contratos/cancelar', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/cancelar/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/reenviar-link/:id', ['controller' => 'ContractManagement', 'action' => 'reenviarLink'], ['pass' => ['id'], 'id' => '\d+'])->setMethods(['POST']);
    $routes->redirect('/modulo-contratos/reenviar-link', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/reenviar-link/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/renovacoes/:id', ['controller' => 'ContractManagement', 'action' => 'verRenovacoes'], ['pass' => ['id'], 'id' => '\d+']);
    $routes->redirect('/modulo-contratos/renovacoes', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/renovacoes/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/aprovar-renovacao/:id', ['controller' => 'ContractManagement', 'action' => 'aprovarRenovacao'], ['pass' => ['id'], 'id' => '\d+']);
    $routes->redirect('/modulo-contratos/aprovar-renovacao', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/aprovar-renovacao/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/recusar-renovacao/:id', ['controller' => 'ContractManagement', 'action' => 'recusarRenovacao'], ['pass' => ['id'], 'id' => '\d+'])->setMethods(['POST']);
    $routes->redirect('/modulo-contratos/recusar-renovacao', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/recusar-renovacao/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/solicitar-renovacao/:id', ['controller' => 'ContractManagement', 'action' => 'solicitarRenovacao'], ['pass' => ['id'], 'id' => '\d+'])->setMethods(['POST']);
    $routes->redirect('/modulo-contratos/solicitar-renovacao', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/solicitar-renovacao/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/pdf/:id', ['controller' => 'ContractManagement', 'action' => 'downloadPdf'], ['pass' => ['id'], 'id' => '\d+']);
    $routes->redirect('/modulo-contratos/pdf', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->redirect('/modulo-contratos/pdf/', ['controller' => 'ContractManagement', 'action' => 'index'], ['status' => 302]);
    $routes->connect('/modulo-contratos/pdf-assinado/:id', ['controller' => 'ContractManagement', 'action' => 'downloadSigned'], ['pass' => ['id'], 'id' => '\d+']);
