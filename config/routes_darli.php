...
Router::scope('/', function ($routes) {
    ...
    /* Timer (Horas Técnicas) – rotas explícitas para evitar 404 em subpasta */
    $routes->connect('/tickets/timer-iniciar/:id', ['controller' => 'Tickets', 'action' => 'timerIniciar'], ['pass' => ['id']]);
    $routes->connect('/tickets/timer-pausar/:id', ['controller' => 'Tickets', 'action' => 'timerPausar'], ['pass' => ['id']]);
    $routes->connect('/tickets/timer-retomar/:id', ['controller' => 'Tickets', 'action' => 'timerRetomar'], ['pass' => ['id']]);
    $routes->connect('/tickets/timer-finalizar/:id', ['controller' => 'Tickets', 'action' => 'timerFinalizar'], ['pass' => ['id']]);
