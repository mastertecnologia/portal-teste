...
/** Dark: pills saturadas (primária PGM + texto branco) — evita fundo mint/ciano “apagado”. */
const BADGE_LIGHT = {
  success:
    'bg-emerald-50 text-emerald-700 border-emerald-200 dark:border-[color:rgba(29,158,117,0.78)] dark:bg-[rgba(29,158,117,0.38)] dark:text-white',
  warning:
  ...
  medium:
    'bg-emerald-50/80 text-emerald-800 border-emerald-200 dark:border-[color:rgba(29,158,117,0.78)] dark:bg-[rgba(29,158,117,0.38)] dark:text-white',
  ...
  progress:
    'bg-teal-50 text-teal-800 border-teal-200 dark:border-[color:rgba(29,158,117,0.78)] dark:bg-[rgba(29,158,117,0.42)] dark:text-white',
  waiting: 'bg-violet-50 text-violet-800 border-violet-200 dark:bg-violet-950/35 dark:text-violet-200 dark:border-violet-800',
  pendingTech:
    'bg-emerald-100 text-emerald-900 border-emerald-300 dark:border-[color:rgba(29,158,117,0.78)] dark:bg-[rgba(29,158,117,0.36)] dark:text-white',
  resolved:
    'bg-emerald-100 text-emerald-900 border-emerald-300 dark:border-[color:rgba(29,158,117,0.72)] dark:bg-[rgba(29,158,117,0.32)] dark:text-white',
...
const BADGE_EMBED = {
  success:
    'border border-[color:rgba(29,158,117,0.75)] bg-[rgba(29,158,117,0.35)] text-white',
  ...
  progress: 'border border-[color:rgba(29,158,117,0.75)] bg-[rgba(29,158,117,0.35)] text-white',
  ...
  resolved:
    'border border-[color:rgba(29,158,117,0.72)] bg-[rgba(29,158,117,0.32)] text-white',
...
export function acaoLinkClassName(key, embed = false) {
  ...
  if (embed && k === 'imprimir') {
    return `${base} border-[color:rgba(29,158,117,0.75)] bg-[rgba(29,158,117,0.32)] text-white hover:brightness-110`;
  }
  if (embed && k === 'cancelar') {
