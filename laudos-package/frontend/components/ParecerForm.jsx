...
import { TemplatesAPI, UtilAPI } from '../services/api';
 ...
 *
 * Props:
 *   parecer: dados completos
 *   onChange: (changes) => void  — chamado com objeto de mudanças (não objeto inteiro)
 */
export default function ParecerForm({ parecer, onChange }) {
  ...
  const handleClientSelect = (cliente) => {
    ...
    onChange({
      ...
      requester_company_name: cliente.razao_social || cliente.nome,
