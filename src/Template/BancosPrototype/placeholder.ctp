<?php
/**
 * Placeholder das telas bancárias (extrato, conciliação, transferências, fluxo).
 *
 * @var \App\View\AppView $this
 * @var string $page
 */
$labels = [
	'contas' => __('Contas Bancárias'),
	'extrato' => __('Extrato'),
	'conciliacao' => __('Conciliação bancária'),
	'transferencias' => __('Transferências / PIX'),
	'fluxo-caixa' => __('Fluxo de Caixa'),
];
$label = (string)($labels[$page] ?? ucfirst((string)$page));
?>
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;flex-wrap:wrap;gap:10px;">
	<div>
		<div style="font-size:11px;color:var(--teal);font-weight:600;text-transform:uppercase;letter-spacing:.4px;margin-bottom:3px;"><?= h(__('Bancos · Protótipo')) ?></div>
...
<div class="card" style="text-align:center;padding:48px 22px;">
	...
	<?= $this->Html->link(__('Ir ao módulo clássico'), ['controller' => 'FinanceiroBancos', 'action' => 'index'], ['class' => 'btn btn-primary btn-sm']) ?>
</div>
