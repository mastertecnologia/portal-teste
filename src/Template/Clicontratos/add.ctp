...
<div class="col-md-12 p-0 clictr-cli-page">
	<div class="cli-form-root cli-layout-unificado">
		<?= $this->Form->create($contrato, ['class' => 'form-material', 'id' => 'form-clicontrato-add']) ?>
		...
		<div class="cli-form-footer">
			...
			<div class="cli-form-footer-right">
				...
				<?= $this->Form->button('<i class="fas fa-check"></i> Cadastrar', ['class' => 'btn-cli-primary', 'escape' => false, 'type' => 'submit']) ?>
			</div>
		</div>
