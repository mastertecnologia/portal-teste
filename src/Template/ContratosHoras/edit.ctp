<?php
	...
	$urlLista = Router::url(['action' => 'index', $contrato->idcliente]);
	$urlFichaCliente = Router::url(['controller' => 'Clientes', 'action' => 'edit', $contrato->idcliente]);
?>
<div class="col-md-12 p-0">
	<div class="cli-form-root cli-layout-unificado">
		<?= $this->Form->create($contrato, ['class' => 'form-material', 'id' => 'form-contratos-horas-edit']) ?>
		...
		<div class="cli-form-footer">
			...
			<div class="cli-form-footer-right">
				<?= $this->Html->link('Cancelar', ['action' => 'index', $contrato->idcliente], ['class' => 'btn-cli-secondary', 'data-turbo' => 'false']) ?>
