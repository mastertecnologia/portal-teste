...
$feMoney = function ($field, $label) use ($view) {
	...
	echo '<label class="control-label text-muted">' . h($label) . '</label>';
...
<h5 class="m-t-5 m-b-10">Totais da nota</h5>
<div class="row">
...
<h5 class="m-t-15 m-b-10">ICMS</h5>
<div class="row">
...
<h5 class="m-t-15 m-b-10">Tributos aproximados (IBPT / transparência)</h5>
<div class="row">
...
<h5 class="m-t-15 m-b-10">IPI, PIS e COFINS</h5>
<div class="row">
...
<h5 class="m-t-15 m-b-10">Serviços / previdência</h5>
<div class="row">
...
<h5 class="m-t-15 m-b-10">IRRF e CSLL</h5>
<div class="row">
