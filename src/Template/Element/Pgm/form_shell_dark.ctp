...
body.layout-no-topbar.pgm-portal-client #<?= $fid ?> .bootstrap-select.open > .dropdown-toggle,
body.layout-no-topbar.pgm-portal-client #<?= $fid ?> .bootstrap-select > .dropdown-toggle:focus{
	border-color:#1d9e75!important;box-shadow:0 0 0 2px rgba(29,158,117,.22)!important;
}
body.layout-no-topbar.pgm-portal-client .clictr-modal-cmp input.form-control,
body.layout-no-topbar.pgm-portal-client .clictr-modal-cmp textarea.form-control{
	background:#21262d!important;border-color:#30363d!important;color:#e6edf3!important;
}
body.layout-no-topbar.pgm-portal-client .clictr-modal-cmp input.form-control:focus,
body.layout-no-topbar.pgm-portal-client .clictr-modal-cmp textarea.form-control:focus{
	border-color:#1d9e75!important;box-shadow:0 0 0 2px rgba(29,158,117,.22)!important;
}
</style>
