	...
	<div class="scroll-sidebar ps ps--theme_default ps--active-y" data-ps-id="5c23612c-2012-1d1a-2b77-a7091df065d9">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<li class="<?= $ticketsActive ?>"> <?= $this->Html->link('<i class="fas fa-ticket-alt"></i><span class="hide-menu"> Tickets </span>', ['controller' => 'Tickets', 'action' => 'index'], ['class' => 'waves-effect waves-dark m-r-0', 'aria-expanded' => 'false', 'escape' => false, ]); ?> </li>
				<?php if (!empty($admin)) : ?>
