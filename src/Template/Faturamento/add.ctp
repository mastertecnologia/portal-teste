...
<div class="fatadd-root">
    ...
    <div class="fatadd-card">
        ...
        <table class="fatadd-items-table" id="tblItens">
            ...
            <tbody id="itensBody">
                <tr class="item-row">
                    ...
                    <td><input type="number" name="itens[0][quantidade]" value="1" min="0.01" step="0.01" class="item-qtd" style="width:70px"></td>
                    <td><input type="number" name="itens[0][valor_unitario]" value="0" min="0" step="0.01" class="item-vuni" style="width:100px"></td>
                    <td><input type="text" name="itens[0][valor_total]" value="0,00" readonly style="width:100px;background:rgba(0,0,0,.2);cursor:default" class="item-vtotal"></td>
        ...
        <div style="text-align:right;margin-top:12px">
            <strong style="font-size:15px;color:#5cdbc0">Total: R$ <span id="totalGeral">0,00</span></strong>
        </div>
