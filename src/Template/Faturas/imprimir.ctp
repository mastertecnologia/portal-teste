...
/* Tema escuro: pré-visualização na tela; @media print acima mantém documento formal claro */
@media screen {
    ...
    html[data-pgm-theme="dark"] #printable .bt,
    html[data-pgm-theme="dark"] #printable .bb,
    html[data-pgm-theme="dark"] #printable .bl,
    html[data-pgm-theme="dark"] #printable .br {
    ...
    html[data-pgm-theme="dark"] #printable .totais-row .campo-valor {
        color: #e8eaed !important;
    }
