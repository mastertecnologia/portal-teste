...
$this->Breadcrumbs->add('Nova despesa');
?>
<style>
...
<div class="fin-root">
    <div class="fin-topbar">
        <h1 class="fin-h1"><i class="fas fa-plus fin-h1-ico"></i>Nova despesa</h1>
    ...
    <div class="fin-card">
        ...
        <div class="fin-row">
            <div class="fin-field">
                ...
                <?= $this->Form->control('descricao', ['label' => false, 'class' => 'form-control', 'placeholder' => 'Ex: Aluguel escritório']) ?>
            </div>
