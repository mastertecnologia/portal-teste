...
$this->Breadcrumbs->add('Recorrentes', ['action' => 'recorrentes']);
...
.fin-field { flex:1; min-width:180px; }
...
<div class="fin-root">
    <div class="fin-topbar">
        <h1 class="fin-h1"><i class="fas fa-plus fin-h1-ico"></i>Novo lançamento recorrente</h1>
        <div><?= $this->Html->link('Voltar', ['action' => 'recorrentes'], ['class' => 'btn btn-default btn-sm']) ?></div>
    </div>

    <div class="fin-card">
        <?= $this->Form->create($recorrente) ?>
        <div class="fin-row">
            <div class="fin-field" style="flex:2;">
                <label>Descrição</label>
                <?= $this->Form->control('descricao', ['label' => false, 'class' => 'form-control', 'placeholder' => 'Ex: Aluguel mensal']) ?>
            </div>
            <div class="fin-field" style="max-width:160px;">
                <label>Tipo</label>
                <?= $this->Form->select('tipo', ['receita' => 'Receita', 'despesa' => 'Despesa'], ['class' => 'form-control']) ?>
            </div>
            <div class="fin-field" style="max-width:160px;">
                <label>Valor (R$)</label>
        ...
        <div class="fin-row">
            <div class="fin-field">
                ...
                <?= $this->Form->select('frequencia', [
                    'semanal' => 'Semanal', 'quinzenal' => 'Quinzenal', 'mensal' => 'Mensal',
                    'trimestral' => 'Trimestral', 'anual' => 'Anual',
                ], ['class' => 'form-control', 'default' => 'mensal']) ?>
            </div>
            <div class="fin-field" style="max-width:120px;">
                <label>Dia vencimento</label>
                <?= $this->Form->control('dia_vencimento', ['label' => false, 'class' => 'form-control', 'type' => 'number', 'min' => 1, 'max' => 28, 'default' => 1]) ?>
            </div>
            <div class="fin-field">
                <label>Data início</label>
                <?= $this->Form->control('data_inicio', ['label' => false, 'type' => 'date', 'class' => 'form-control']) ?>
            </div>
            <div class="fin-field">
                <label>Data fim (opcional)</label>
                <?= $this->Form->control('data_fim', ['label' => false, 'type' => 'date', 'class' => 'form-control', 'empty' => true]) ?>
            </div>
        </div>
        <div class="fin-row">
            <div class="fin-field">
        ...
        <div class="fin-row">
            <div class="fin-field fin-field-full">
                ...
                <?= $this->Form->textarea('observacoes', ['class' => 'form-control', 'rows' => 2]) ?>
            </div>
        </div>
