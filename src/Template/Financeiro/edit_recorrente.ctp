...
<div class="fin-root">
    <div class="fin-topbar">
        <h1 class="fin-h1"><i class="fas fa-edit fin-h1-ico"></i>Editar recorrente #<?= $recorrente->id ?></h1>
    ...
    <div class="fin-card">
        ...
        <div class="fin-row">
            ...
            <div class="fin-field" style="max-width:120px;">
                ...
                <?= $this->Form->control('dia_vencimento', ['label' => false, 'class' => 'form-control', 'type' => 'number', 'min' => 1, 'max' => 28]) ?>
            </div>
            <div class="fin-field">
