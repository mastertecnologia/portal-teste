...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;flex-wrap:wrap;gap:10px;">
	...
	<div style="display:flex;gap:8px;flex-wrap:wrap;">
		<?= $this->Html->link('📤 ' . __('Remessa CNAB'), ['controller' => 'BancosPrototype', 'action' => 'view', 'remessa'], ['class' => 'btn btn-ghost btn-sm', 'escape' => false]) ?>
		<?= $this->Html->link('📥 ' . __('Importar retorno'), ['controller' => 'BancosPrototype', 'action' => 'view', 'retorno'], ['class' => 'btn btn-blue btn-sm', 'escape' => false]) ?>
