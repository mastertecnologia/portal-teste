...
<head>
	...
	<!--- Scripts — path com / inicial: ficheiros estão em webroot/dist e webroot/assets, não em js/ -->
	...
	<!-- CSS — path com / inicial: evita App.cssBaseUrl (css/) duplicado; ficheiros em dist/css -->
