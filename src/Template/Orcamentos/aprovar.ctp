...
$this->Breadcrumbs->add('Aprovar Orçamento', [], ['class' => 'breadcrumb-item active']);
...
<div class="orc-premium-wrap orc-premium-form">
	<div class="orc-page-head">
		<div>
			...
			<h1 class="orc-h1">Aprovar orçamento</h1>
		</div>
	</div>
		...
		<div class="card-body">
			...
			<div class="tab-content">
				...
				<div class="orc-footer-bar">
					<?= $this->Html->link('Voltar para o Orçamento', ["action" => $action, $orcamento->id], ['class' => 'btn btn-orc-form-secondary btn-orc-compact']); ?>
					<?= $this->Form->button('Orçamento Aprovado', ['class' => 'btn btn-orc-premium-primary btn-orc-compact']) ?>
				</div>
			</div>
