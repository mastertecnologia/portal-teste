...
$this->Breadcrumbs->add('Arquivar Orçamento', [], ['class' => 'breadcrumb-item active']);
?>
...
<div class="orc-premium-wrap orc-premium-form">
	<div class="orc-page-head">
		<div>
			...
			<h1 class="orc-h1">Arquivar orçamento</h1>
		</div>
	</div>
		...
		<div class="card-body">
			...
			<div class="tab-content">
				...
				<div class="orc-footer-bar">
					...
					<?= $this->Form->button('Arquivar Orçamento', ['class' => 'btn btn-orc-neutral-strong btn-orc-compact']) ?>
				</div>
			</div>
