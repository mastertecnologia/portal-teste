...
$this->Breadcrumbs->add('Orçamento', ['controller' => 'Orcamentos', 'action' => 'index'], ['class' => 'breadcrumb-item']);
$this->Breadcrumbs->add('Editar', ['controller' => 'Orcamentos', 'action' => 'edit', $orcamento->id], ['class' => 'breadcrumb-item']);
$this->Breadcrumbs->add('Recusar Orçamento', [], ['class' => 'breadcrumb-item active']);
?>
...
<div class="orc-premium-wrap orc-premium-form">
	<div class="orc-page-head">
		<div>
			...
			<h1 class="orc-h1">Recusar orçamento</h1>
		</div>
	</div>
		...
		<div class="card-body">
			...
			<div class="tab-content">
				...
				<div class="orc-footer-bar">
					...
					<?= $this->Form->button('Orçamento Recusado', ['class' => 'btn btn-orc-danger-solid btn-orc-compact']) ?>
				</div>
			</div>
