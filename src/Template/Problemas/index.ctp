<div class="col-md-12">
	<div class="card">
		<div class="card-body">
			<?= $this->Html->link('Cadastrar um novo Tipo de OS', ['action' => 'add'], ['class' => 'btn btn-pgm btn-pgm-salvar btn-success m-t-20 m-r-5 m-b-20', 'target' => '_blank']); ?>
                    ...
                    <tbody>
                        <?php foreach ($problemas as $reg): ?>
                            <tr>
								...
								<td><?= $this->Html->link('Excluir', ["controller" => "Problemas", "action" => "delete", $reg->id], ['class' => 'label label-danger']) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
