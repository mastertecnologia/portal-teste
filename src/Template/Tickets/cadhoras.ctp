...
$this->Breadcrumbs->add('Editar', ['controller' => 'Tickets', 'action' => 'edit', $idticket], ['class' => 'breadcrumb-item']);
...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            <?= $this->Form->create(null, ['class' => 'form-material', 'url' => ['controller' => 'Ticketshoras', 'action' => 'add', $idticket]]); ?>
            <div class="row">
