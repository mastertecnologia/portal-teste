<?php
	...
	/* ΓöÇΓöÇ Active-state helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
	$roleNav = (int)($role ?? 1);
	...
	/* ΓöÇΓöÇ Chevron SVG reutiliz├ível ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
...
<aside class="left-sidebar skin-pgm pgm-sidebar-shell">
	...
	<!-- ΓöÇΓöÇ Brand ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
	<div class="pgm-sidebar-brand">
		<?= $this->Html->link(
			...
			<div class="pgm-sidebar-titles hide-menu">
				<strong>PGM Solu├º├╡es em TI</strong>
	...
	<!-- ΓöÇΓöÇ Workspace / Empresa ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
	...
	<!-- ΓöÇΓöÇ Busca de fun├º├╡es ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
	...
	<div class="pgm-sb-search-block">
		<div class="pgm-sidebar-functions-search" id="pgm-sidebar-functions-search">
			<div class="pgm-sb-sbox">
				...
				<input type="text" id="pesquisa-funcoes" autocomplete="off" placeholder="Buscar fun├º├╡esΓÇª" />
			</div>
	...
	<div class="scroll-sidebar ps ps--theme_default ps--active-y" data-ps-id="5c23612c-2012-1d1a-2b77-a7091df065d9">
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ IN├ìCIO ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				<li class="pgm-nav-section-label" aria-hidden="true"><span>In├¡cio</span></li>
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ CADASTROS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				<?php
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ ATENDIMENTO ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				<?php
				...
				<li class="pgm-ng <?= h($ticketsActive) ?> <?= $ticketsOpen ? 'open' : '' ?>">
					...
					<ul class="pgm-nc list-unstyled">
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Hist├│rico de atendimentos</span>',
				...
				<li class="pgm-ng <?= h($ordensActive) ?> <?= $osOpen ? 'open' : '' ?>">
					<div class="pgm-np <?= $osOpen ? 'open-p' : '' ?>" role="button" tabindex="0" aria-expanded="<?= $osOpen ? 'true' : 'false' ?>">
						...
						<span class="hide-menu">Ordens de Servi├ºo</span>
						<?php if ($osIndexActive) : ?>
							<span class="pgm-os-badge hide-menu" id="badge-exec-os">ΓÇö</span>
						<?php endif; ?>
						<?= $chevronSvg ?>
					</div>
					<ul class="pgm-nc list-unstyled">
				...
				<li class="<?= $queuesAtendimentoActive ?>">
					<?= $this->Html->link(
						'<i class="fas fa-layer-group"></i><span class="hide-menu"> Filas / t├⌐cnicos</span>',
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ COMERCIAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				<?php
				...
				<li class="<?= $orcamentosActive ?>">
					<?= $this->Html->link(
						'<i class="fas fa-file-invoice-dollar"></i><span class="hide-menu"> Or├ºamentos</span>',
				...
				<li class="<?= $prefaturamentoActive ?>">
					<?= $this->Html->link(
						'<i class="fas fa-clipboard-check"></i><span class="hide-menu"> Pr├⌐-faturamento</span>',
				...
				<li class="<?= $faturasActive ?>">
					<?= $this->Html->link(
						'<i class="fas fa-file-invoice"></i><span class="hide-menu"> Loca├º├úo</span>',
				...
				<li class="pgm-ng <?= h($advancedModuleActive) ?> <?= $advModOpen ? 'open' : '' ?>">
					...
					<ul class="pgm-nc list-unstyled">
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Gest├úo de contratos</span>',
							'/modulo-contratos',
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ FINANCEIRO ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				...
				<li class="pgm-ng <?= $financeiroActive ?> <?= $finOpen ? 'open' : '' ?>">
					...
					<ul class="pgm-nc list-unstyled">
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Concilia├º├úo banc├íria</span>',
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Relat├│rios</span>',
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ FISCAL ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				<?php
				...
				<li class="pgm-ng <?= h($fiscalModuleActive) ?> <?= $fiscalOpen ? 'open' : '' ?>">
					<div class="pgm-np <?= $fiscalOpen ? 'open-p' : '' ?>" role="button" tabindex="0" aria-expanded="<?= $fiscalOpen ? 'true' : 'false' ?>">
						...
						<span class="hide-menu">M├│dulo Fiscal</span>
						<?= $chevronSvg ?>
					</div>
					<ul class="pgm-nc list-unstyled">
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Notas de sa├¡da</span>',
						...
						<?php if (($sg['fiscal_menu_notas'] ?? true)) : ?>
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Inutilizar num. (sa├¡da)</span>',
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>S├⌐ries (sa├¡da)</span>',
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>S├⌐ries (entrada)</span>',
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Conting├¬ncia</span>',
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Configura├º├úo</span>',
				...
				<!-- ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ FERRAMENTAS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
				<?php
				...
				<li class="pgm-ng <?= h($relActive) ?> <?= $relatoriosOpen ? 'open' : '' ?>">
					...
					<ul class="pgm-nc list-unstyled">
						...
						<li><?= $this->Html->link(
							'<span class="pgm-ndot"></span><span>Indicadores avan├ºados</span>',
	...
	<!-- ΓöÇΓöÇ Footer usu├írio ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ -->
	<div class="pgm-sidebar-footer">
		...
		<div class="pgm-sf-actions hide-menu">
			...
			<?= $this->Html->link(
				'<i class="ti-settings"></i>',
				['controller' => 'config', 'action' => 'index'],
				['class' => 'pgm-sf-act', 'escape' => false, 'title' => 'Permiss├╡es RBAC / cat├ílogo']
			) ?>
			<?php endif; ?>
				...
				<div class="dropdown dropup">
					<a href="javascript:void(0)" class="dropdown-toggle u-dropdown link hide-menu text-white d-flex align-items-center" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
						...
						<div class="pgm-sf-user-info hide-menu">
							...
							<span class="pgm-sf-user-role"><?= !empty($admin) ? 'Administrador' : 'Usu├írio' ?></span>
						</div>
					...
					<div class="dropdown-menu animated flipInY">
						...
						<?= $this->Html->link('<i class="ti-lock"></i> Verifica├º├úo login', ['controller' => 'users', 'action' => 'loginduasetapas'], ['class' => 'dropdown-item', 'escape' => false]) ?>
						<?php endif; ?>
						<?php if (!empty($showConfigAdminHub)) {
							...
							echo $this->Html->link('<i class="ti-settings"></i> Permiss├╡es RBAC / cat├ílogo', ['controller' => 'config', 'action' => 'index'], ['class' => 'dropdown-item', 'escape' => false]);
						} ?>
